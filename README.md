...
5. Export the following measurements (mean, standard deviation, count and SEM):  
    ...
    - **ANₜ:** normalized area value at the final time point of the FIS assay (Aₜ), using normalization factor A₀ = 100%.


        <p align="center"><img src="./img/schemes/3measurements_400x347.png"></p>


        _Graphical representation of the three FIS outputs generated by Organoid Analyst: AUC, ISR and ANₜ. Notice the  ~10 min lag between CFTR stimulation at the beginning of the assay (t = 0 min) and the linear swelling region where ISR is measured (t = 10 ~ 30 min)._
...
15. This section allows interactive data exploration, image visualization and per well quality control.
    ...
    * **Plots:** Organoid Analyst visualizes the quantitative FIS data in five different plots:
        ...
        * Bar plots representing summarized AUC, ISR and ANₜ measurements (average ± standard deviation, across identically treated wells).  
...
17. Organoid Analyst will save the following files:
    ...
    * `FIS_summary_xxmin.xlsx` Per-treatment summary of AUC, ISR and ANₜ measurements.
    * `FISanalysis_dd-mm-yy_hh-ss.log` Organoid Analyst settings at the moment of data export.
    * `plot_AtA0_xxmin.png` Bar plot of summarized ANₜ measurements.
