        ...
        if(!is.integer(input$Settings_folderInput)){
            ...
            output$UI_ExpSettings     <- renderUI({
                tagList(
                    ...
                    fluidRow(
                        ...
                        tags$style(type='text/css', "#help_Settings_colTime {margin-top: 41px;}"),
                        tags$style(type='text/css', "#help_Settings_colWell {margin-top: 41px;}"),
                        tags$style(type='text/css', "#help_Settings_colCompound {margin-top: 40px;}"),
                        tags$style(type='text/css', "#help_Settings_colConcentration {margin-top: 40px;}"),
                        tags$style(type='text/css', "#help_Settings_numRows {margin-top: 40px;}"),
            ...
            output$UI_QCSettings2     <- renderUI({
                ...
                fluidRow(
                    ...
                    tags$style(type='text/css', "#help_Settings_colX {margin-top: 40px;}"),
                    tags$style(type='text/css', "#help_Settings_colY {margin-top: 40px;}")
                )
            })
            ...
            output$UI_RemapSettings2  <- renderUI({
                tagList(
                    fluidRow(
                        ...
                        tags$style(type='text/css', "#help_Settings_pathInTable {margin-top: 67px;}"),
                        tags$style(type='text/css', "#help_Settings_pathInComputer {margin-top: 41px;}")
                    )
                )
            })
            ...
            output$UI_MasksSettings3  <- renderUI({
                ...
                tagList(
                    fluidRow(
                        ...
                        tags$style(type='text/css', "#help_Settings_maskFileSuffix {margin-top: 86px;}")
                    )
                )
            })
